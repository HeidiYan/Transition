...
# 1. read raw data for experiment 2
...
def do_sampling_given_switchpoint(sub_id, rt, trialindex, conds, sp):
    ...
    with model: # define model as following
        ...
        trace = pm.sample(40000, step=step, start=model.test_point, chains=8, cores=8)  # MCMC采样
...
if __name__ == '__main__':
    ...
    tpdata=pd.read_csv('exp2_tp.csv')
    ...
    ##
    # import data
    mydata=pd.read_csv('exp2_expdata.csv')
    # delete if acc==0
